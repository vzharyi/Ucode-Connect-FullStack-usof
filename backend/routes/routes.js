...
/* + */router.get('/api/auth/me', authenticateToken, authenticationController.findUser);
...
/* + */router.post('/api/auth/password-reset', authenticationController.sendPasswordResetEmail);
/* + */router.post('/api/auth/password-reset/:confirm_token', authenticationController.confirmNewPassword);
...
/* + */router.patch('/api/users/avatar', authenticateToken, permissionManager.checkPermission('uploadAvatar'), upload.single('profile_picture'), userController.uploadAvatar);
...
router.post('/api/comments/:comment_id/reply', authenticateToken, permissionManager.checkPermission('createReply'), commentsController.createReply);
